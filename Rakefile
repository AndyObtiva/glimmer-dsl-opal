...
unless jeweler_required.nil?
  Jeweler::Tasks.new do |gem|
    ...
    gem.description = %Q{Glimmer DSL for Opal on Rails (Pure Ruby Web GUI and Auto-Webifier of Desktop Apps)}
    gem.email = "andy.am@gmail.com"
    gem.authors = ["AndyMaleh"]
    gem.executables = []
    gem.files = Dir['README.md', 'LICENSE.txt', 'VERSION', 'lib/**/*', 'samples/**/*', 'app/**/*', 'config/**/*']
