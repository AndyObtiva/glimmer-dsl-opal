...
# -*- encoding: utf-8 -*-
# stub: glimmer-dsl-opal 0.7.5 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2020-12-10"
  s.description = "Glimmer DSL for Opal (Pure Ruby Web GUI and Auto-Webifier of Desktop Apps Running via Opal on Rails)".freeze
