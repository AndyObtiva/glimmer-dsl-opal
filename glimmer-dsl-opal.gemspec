...
# -*- encoding: utf-8 -*-
# stub: glimmer-dsl-opal 0.26.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/glimmer-dsl-opal/samples/hello/hello_sash_form.rb",
    ...
    "lib/glimmer-dsl-opal/vendor/jquery.sash/jquery.sash.css",
    "lib/glimmer-dsl-opal/vendor/jquery.sash/jquery.sash.js",
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<opal-async>.freeze, ["~> 1.3.0"])
    ...
    s.add_dependency(%q<opal-async>.freeze, ["~> 1.3.0"])
